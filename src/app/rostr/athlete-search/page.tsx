...
function Content() {
    ...
    return (
        <Container className='w-full h-full flex flex-col'>
            <ResumeModal />
            <div className='flex flex-row mb-4 justify-between md:justify-start gap-16'>
                <Link href='/rostr' className='text-slate-300 hover:text-slate-400 inline-flex gap-x-2 items-end'>
                ...
                <Link href={`/rostr/${rostr.id}`} className='text-slate-300 hover:text-slate-400 inline-flex gap-x-2 items-end'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 mb-1">
