...
import { Prose } from '@/components/tailwindui/Prose'
import { type ArticleInfo } from '@/lib/articles'
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <article>
            <header className="flex flex-col">
              <h1 className="mt-6 text-4xl font-bold tracking-tight sm:text-5xl text-zinc-100">
                {article.title}
              </h1>
              <time
