    ...
    return ((totalResults > 0) && <div className="mt-4 mx-auto flex flex-row items-end justify-center space-x-4">
      ...
      <div className="flex">
        <button
            ...
            className="relative inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-200 focus-visible:outline-offset-0 disabled:opacity-50"
          >
            Previous
          </button>
          <button
            className="relative ml-3 inline-flex items-center rounded-md  bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-200 focus-visible:outline-offset-0 disabled:opacity-50"
              onClick={handleNext}
