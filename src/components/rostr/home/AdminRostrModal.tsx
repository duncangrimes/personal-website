                        ...
                        <DialogPanel
                            ...
                            <form className='flex flex-col' onSubmit={handleSubmit} id='create-admin-recruit-rostr'>
                                ...
                                <div className='sm:grid-cols-3 sm:grid flex flex-col items-center justify-center mt-4 '>
                                    <div/>
                                    <Button
                                    className="self-center mx-auto items-center gap-2 min-h-8 rounded-md bg-gray-700 py-1.5 px-3 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-gray-600 data-[focus]:outline-1 data-[focus]:outline-white data-[open]:bg-gray-700"
                                    type={'submit'}
                                    disabled={isPending}
                                    >
