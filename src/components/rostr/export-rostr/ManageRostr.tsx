...
export default function ManageRostr({rostrId, adminEmail}: {rostrId: string, adminEmail: string}) {
    ...
    return (<div className="flex flex-col">
            <div className='flex flex-row md:justify-start justify-between text-md items-end md:space-x-16'>
                ...
                <Link href={`/rostr/athlete-search${rostr ? `?rostrId=${rostr.id}` : null}`} className="inline-flex items-center justify-start text-slate-300 hover:text-slate-400 mb-8">
        ...
        {rostr ? <div className='flex flex-col md:flex-row md:justify-between justify-center border-y-2 text-gray-200 border-gray-500 p-4'>
            <div className='flex flex-col item-start max-w-[70%]'>
                ...
                {rostr.companyName && <div className="flex-inline flex items-end">
                    ...
                    <p className='text-base'> {rostr.companyName}</p>
                 </div>}
                {rostr.location && <div className="flex-inline flex items-end">
                    ...
                    <p className='text-base'> {rostr.location}</p>
                </div>}
